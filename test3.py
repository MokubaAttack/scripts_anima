...
def safe2diff(safe_path):
	...
	snapshot_download(repo_id="circlestone-labs/Anima-Base-v1.0-Diffusers", local_dir=base_path)
	...
	lines=[]
	for line in f:
		if '"circlestone-labs/Anima-Base-v1.0-Diffusers"' in line:
			line=line.replace('"circlestone-labs/Anima-Base-v1.0-Diffusers"','"'+base_path+'"')
		lines.append(line)
	f.close()
	f=open(json_path,"w")
	for line in lines:
